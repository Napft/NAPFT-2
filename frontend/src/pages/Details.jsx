        ...
        <div className="nftAbout">
          <div className="userDiv">
            ...
            <p className="by">
              Owned by{" "}
              <span
                className="id cursor-pointer text-blue-500"
                onClick={() => setshowowner(!showowner)}
              >
                {showowner == false ? owner.substring(0, 9) + "..." : owner}
              </span>
            </p>
          </div>
          ...
          <div className="desc">
            ...
            <div className="innerDesc">{/* <p>This is a NFT</p> */}</div>
          </div>
          <div className="priceDiv">
            <p className="price">Current price</p>
            <p className="eth">{price} MATIC</p>
